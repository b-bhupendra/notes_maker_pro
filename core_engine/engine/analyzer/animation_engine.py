...
ANIMATION_SYSTEM_PROMPT = Template(
    ...
    "Use a sketchy, hand-drawn aesthetic (black strokes, no fill for outlines).\n"
    "Include a <style> block inside the SVG. "
    "Use CSS @keyframes to animate the elements. "
    "For example, to show a molecule moving, animate its transform property.\n\n"
    "Use sequential animation-delay properties so the steps happen one after another. "
    "The total animation loop should last between 5 to 10 seconds.\n\n"
    "Include <text> elements that act as labels, fading in when the relevant part of the animation occurs.\n\n"
    "STRICT RULES FOR BASIC MODELS:\n"
    "1. Use ONLY basic shapes: <rect>, <circle>, <line>, <text>.\n"
    "2. Do NOT use complex <path> data (no 'd=' attributes with curves or arc commands).\n"
    "3. Limit to MAX 3 animation steps to stay within model capabilities.\n\n"
    "Transcript Chunk:\n"
    "$transcript\n\n"
